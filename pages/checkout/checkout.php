                                    ...
                                    foreach ($mac_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            ...
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=mac" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown ipad-dropdown" id="ipad-dropdown">
                                    ...
                                    foreach ($ipad_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=ipad" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown iphone-dropdown" id="iphone-dropdown">
                                    ...
                                    foreach ($iphone_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=iphone" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown watch-dropdown" id="watch-dropdown">
                                    ...
                                    foreach ($watch_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=watch" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown music-dropdown" id="music-dropdown">
                                    ...
                                    foreach ($music_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=music" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown airtag-dropdown" id="airtag-dropdown">
                                    ...
                                    foreach ($airtag_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=airtag" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                                ...
                                <div class="dropdown aksesori-dropdown" id="aksesori-dropdown">
                                    ...
                                    foreach ($aksesori_categories as $kategori) {
                                        ...
                                        if (mysqli_num_rows($produk_result) > 0) {
                                            echo '<ul>';
                                            while ($produk = mysqli_fetch_assoc($produk_result)) {
                                                echo '<li><a href="checkout.php?id=' . $produk['id'] . '&tipe=aksesoris" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a></li>';
                                            }
                                            echo '</ul>';
                                        }
                                    }
                    ...
                    <li class="has-dropdown" data-menu="ipad">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($ipad_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=ipad" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
                    ...
                    <li class="has-dropdown" data-menu="iphone">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($iphone_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=iphone" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
                    ...
                    <li class="has-dropdown" data-menu="watch">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($watch_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=watch" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
                    ...
                    <li class="has-dropdown" data-menu="music">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($music_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=music" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
                    ...
                    <li class="has-dropdown" data-menu="airtag">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($airtag_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=airtag" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
                    ...
                    <li class="has-dropdown" data-menu="aksesori">
                        ...
                        <div class="sidebar-dropdown">
                            ...
                            foreach ($aksesori_categories as $kategori) {
                                ...
                                if (mysqli_num_rows($produk_result) > 0) {
                                    while ($produk = mysqli_fetch_assoc($produk_result)) {
                                        echo '<a href="checkout.php?id=' . $produk['id'] . '&tipe=aksesoris" class="dropdown-product-link">' . htmlspecialchars($produk['nama_produk']) . '</a>';
                                    }
                                }
                            }
                            ?>
