    ...
    <style>
        ...
        * {
        ...
        .button {
            ...
            color: #ffffff;
            padding: 8px 16px; /* DIPERKECIL: dari 10px 22px */
            border-radius: 980px;
            ...
            width: auto;
            min-width: 120px; /* Lebar minimum yang sama untuk semua */
        }

        .button:hover {
            background-color: var(--apple-blue-hover);
            transform: scale(1.05);
            box-shadow: 0 4px 15px rgba(0, 113, 227, 0.25); /* DIPERKECIL */
        }
        ...
        .button:hover::after {
            width: 200px; /* DIPERKECIL: dari 300px */
            height: 200px; /* DIPERKECIL: dari 300px */
        }
        ...
        .content-right {
            ...
            display: flex;
            flex-direction: column;
            align-items: flex-end; /* Agar button sejajar kanan */
        }
        ...
        .button i {
            ...
            opacity: 0;
            transform: translateX(-8px); /* DIPERKECIL */
        ...
        @media (max-width: 900px) {
            ...
            .content-right {
                text-align: center;
                max-width: 100%;
                align-items: center; /* Di mobile, button di tengah */
            }
            ...
            .button {
                min-width: 110px; /* Sedikit lebih kecil di mobile */
            }
        }
