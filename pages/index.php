...
<body>
    ...
    <style>
        ...
        .dropdown {
            ...
            max-height: 0;
            overflow: hidden;
            overflow-y: auto; /* Mengganti overflow: hidden dengan overflow-y: auto */
            scrollbar-width: thin; /* Untuk Firefox */
            scrollbar-color: rgba(0, 122, 255, 0.3) transparent; /* Untuk Firefox */
        }
        ...
        .dropdown.active {
            ...
            max-height: 70vh; /* Menggunakan viewport height untuk batas maksimal */
        ...
        .sidebar-menu {
            ...
            overflow-y: auto;
            position: relative;
            -webkit-overflow-scrolling: touch; /* Untuk scroll yang lebih smooth di mobile */
        }
        ...
        .sidebar-dropdown {
            ...
            max-height: 0;
            overflow: hidden;
            overflow-y: auto; /* Tambahkan untuk scroll */
        ...
        .sidebar-dropdown.active {
            max-height: 65vh; /* Menggunakan viewport height */
            overflow-y: auto;
        }
