...
<body>
    ...
    <div class="products-container">
        ...
        <div class="products-header">
            <h1 class="products-title">Produk Terbaru</h1>
            <p class="products-subtitle">Produk Apple terbaru dan paling update</p>
        </div>
        ...
        <div class="products-grid">
            ...
            <?php else: ?>
                <div class="empty-state" style="grid-column: 1 / -1;">
                    ...
                    <p>Produk terbaru akan segera ditampilkan</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function fetchCartData() {
                ...
                // produk-terbaru is 3 layers deep
