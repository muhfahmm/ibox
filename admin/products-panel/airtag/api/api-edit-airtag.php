...
try {
    ...
    foreach ($warna_data as $index => $w_data) {
        ...
        $hex_code = mysqli_real_escape_string($db, $w_data['hex_code'] ?? '');
        ...
        $q_img = "INSERT INTO admin_produk_airtag_gambar (produk_id, warna, hex_code, foto_thumbnail, foto_produk) VALUES ('$product_id', '$warna_nama', '$hex_code', '$thumbnail_name', '$json_imgs')";
