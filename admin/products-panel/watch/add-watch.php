...
<body>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kategori" name="kategori" placeholder="Contoh: Watch Series 9, Watch SE, Watch Ultra" required>
                            </div>
    ...
    <script>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <div class="hex-input-wrapper">
                                    <input type="text" class="form-control color-hex" name="warna_case[${colorIndex}][hex_code]" placeholder="000000" oninput="updateColorPreview(this, ${colorIndex})">
                                </div>
        ...
        function handleColorPicker(picker, idx) {
            ...
            const preview = document.getElementById(`color-preview-${idx}`);
            const hexInput = document.querySelector(`input[name="warna_case[${idx}][hex_code]"]`);
