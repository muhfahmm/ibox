...
// Ambil data produk Apple Watch dengan kombinasi
$query = "SELECT p.*, 
...
// Dapatkan ID pertama untuk Watch
$watch_first_id_query = "SELECT MIN(id) as first_id FROM admin_produk_watch";
$watch_first_id_result = mysqli_query($db, $watch_first_id_query);
$watch_first_id_data = mysqli_fetch_assoc($watch_first_id_result);
$watch_first_id = $watch_first_id_data['first_id'];
...
<head>
    ...
    <title>Admin Panel - Kelola Apple Watch</title>
    ...
    <div class="admin-container">
            ...
            <div class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="watch.php<?php echo $watch_first_id ? '?id=' . $watch_first_id : ''; ?>">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-clock me-2"></i> Kelola Produk Apple Watch</h1>
                <a href="add-watch.php" class="btn-add">
                    <i class="fas fa-plus"></i> Tambah Produk Watch
                </a>
            </div>

            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-list me-2"></i> Daftar Produk Apple Watch</h3>
                </div>
                <div class="card-body">
                    <div class="table-container">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php while($product = mysqli_fetch_assoc($result)): 
                                        ...
                                        $query_thumbnail = "SELECT foto_thumbnail FROM admin_produk_watch_gambar WHERE produk_id = '{$product['id']}' LIMIT 1";
                                        $result_thumbnail = mysqli_query($db, $query_thumbnail);
                                        $thumbnail = mysqli_fetch_assoc($result_thumbnail);
                                        
                                        // Ambil semua warna case untuk produk ini
                                        $query_warna = "SELECT DISTINCT warna_case FROM admin_produk_watch_kombinasi WHERE produk_id = '{$product['id']}'";
                                        $result_warna = mysqli_query($db, $query_warna);
                                        $warna_list = mysqli_fetch_all($result_warna, MYSQLI_ASSOC);
                                        
                                        // Ambil semua ukuran case
                                        $query_ukuran = "SELECT DISTINCT ukuran_case FROM admin_produk_watch_kombinasi WHERE produk_id = '{$product['id']}'";
                                        $result_ukuran = mysqli_query($db, $query_ukuran);
                                        $ukuran_list = mysqli_fetch_all($result_ukuran, MYSQLI_ASSOC);
                                    ...
                                    <tr>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <?php else: ?>
                                                    <div class="thumbnail-img" style="background: #f0f0f0; display: flex; align-items: center; justify-content: center;">
                                                        <i class="fas fa-clock" style="color: #ccc; font-size: 24px;"></i>
                                                    </div>
                                                <?php endif; ?>
                                                <div class="product-details">
                                                    <div class="product-title">
                                                        ...
                                                        <?php if(!empty($product['seri'])): ?>
                                                            <span class="series-badge"><?php echo htmlspecialchars($product['seri']); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="product-stats">
                                                        ...
                                                        <span class="stat-badge">
                                                            <i class="fas fa-tags"></i>
                                                            <?php 
                                                            $warna_names = array_column($warna_list, 'warna_case');
                                        ...
                                        <td>
                                            <div class="product-stats">
                                                ...
                                                <?php if(count($ukuran_list) > 0): ?>
                                                <span class="stat-badge">
                                                    <i class="fas fa-expand-alt"></i>
                                                    <?php 
                                                    $ukuran_names = array_column($ukuran_list, 'ukuran_case');
                                                    echo implode(', ', $ukuran_names);
                                                    ?>
                                                </span>
                                                <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="view-watch.php?id=<?php echo $product['id']; ?>" class="btn-view">
                                                    <i class="fas fa-eye"></i> Lihat
                                                </a>
                                                <a href="edit-watch.php?id=<?php echo $product['id']; ?>" class="btn-edit">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="delete-watch.php?id=<?php echo $product['id']; ?>" class="btn-delete" 
                        ...
                        <?php else: ?>
                            <div class="no-data">
                                <i class="fas fa-clock"></i>
                                <h4>Belum ada produk Apple Watch</h4>
                                <p>Mulai dengan menambahkan produk Apple Watch pertama Anda</p>
                                <a href="add-watch.php" class="btn-add mt-3" style="display: inline-flex;">
