...
// Ambil data produk Music dengan kombinasi
$query = "SELECT p.*, 
...
// Dapatkan ID pertama untuk Music
$music_first_id_query = "SELECT MIN(id) as first_id FROM admin_produk_music";
$music_first_id_result = mysqli_query($db, $music_first_id_query);
$music_first_id_data = mysqli_fetch_assoc($music_first_id_result);
$music_first_id = $music_first_id_data['first_id'];
...
<head>
    ...
    <title>Admin Panel - Kelola Music</title>
    ...
    <div class="admin-container">
            ...
            <div class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="music.php<?php echo $music_first_id ? '?id=' . $music_first_id : ''; ?>">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-headphones-alt me-2"></i> Kelola Produk Music</h1>
                <a href="add-music.php" class="btn-add">
                    <i class="fas fa-plus"></i> Tambah Produk Music
                </a>
            </div>

            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-list me-2"></i> Daftar Produk Music</h3>
                </div>
                <div class="card-body">
                    <div class="table-container">
                        ...
                        <?php else: ?>
                            <div class="no-data">
                                <i class="fas fa-headphones-alt" style="font-size: 50px; color: #ddd; margin-bottom: 15px;"></i>
                                <h4>Belum ada produk Music</h4>
                                <p>Mulai dengan menambahkan produk Music pertama Anda</p>
                                <a href="add-music.php" class="btn-add mt-3" style="display: inline-flex;">
