...
$query_combinations = "SELECT * FROM admin_produk_music_kombinasi WHERE produk_id = '$product_id' ORDER BY warna, tipe, konektivitas";
...
<head>
    ...
    <title>Detail Produk Music - <?php echo htmlspecialchars($product['nama_produk']); ?></title>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="music.php" class="btn-back me-2">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        <a href="edit-music.php?id=<?php echo $product_id; ?>" class="btn-edit">
            ...
            <div class="card-body">
                ...
                <!-- Combinations Table -->
                <!-- KOLOM MUSIC: Tipe, Konektivitas (menggantikan Penyimpanan dan Konektivitas iPhone) -->
                <div class="mb-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="type-badge">
                                                <?php echo htmlspecialchars($combo['tipe']); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <span class="connectivity-badge">
                ...
                <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                    <a href="music.php" class="btn-back">
                        <i class="fas fa-arrow-left"></i> Kembali ke Daftar
                    </a>
                    <div>
                        <a href="edit-music.php?id=<?php echo $product_id; ?>" class="btn-edit me-2">
                            <i class="fas fa-edit"></i> Edit Produk
                        </a>
                        <a href="delete-music.php?id=<?php echo $product_id; ?>" 
