...
$query_product = "SELECT * FROM admin_produk_ipad WHERE id = '$product_id'";
...
$query_combinations = "SELECT * FROM admin_produk_ipad_kombinasi WHERE produk_id = '$product_id' ORDER BY warna, penyimpanan, konektivitas";
...
$query_images = "SELECT * FROM admin_produk_ipad_gambar WHERE produk_id = '$product_id'";
...
<head>
    ...
    <title>Detail Produk iPad - <?php echo htmlspecialchars($product['nama_produk']); ?></title>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="ipad.php" class="btn-back me-2">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        <a href="edit-ipad.php?id=<?php echo $product_id; ?>" class="btn-edit">
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                <?php if(count($combinations) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($combo['penyimpanan']); ?></td>
                                        <td>
                                            <span class="badge bg-info bg-opacity-10 text-info">
                                                <?php echo htmlspecialchars($combo['konektivitas']); ?>
                                            </span>
                                        </td>
                                        <td>
                                            <?php if($has_discount): ?>
                ...
                <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                    ...
                    <div>
                        <a href="edit-ipad.php?id=<?php echo $product_id; ?>" class="btn-edit me-2">
                            <i class="fas fa-edit"></i> Edit Produk
                        </a>
                        <a href="delete-ipad.php?id=<?php echo $product_id; ?>" 
