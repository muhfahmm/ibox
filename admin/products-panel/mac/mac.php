...
<head>
    ...
    <title>Admin Panel - Kelola Mac</title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-laptop me-2"></i> Kelola Produk Mac</h1>
                <a href="add-mac.php" class="btn-add">
                    <i class="fas fa-plus"></i> Tambah Produk Mac
                </a>
            </div>

            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-list me-2"></i> Daftar Produk Mac</h3>
                </div>
                <div class="card-body">
                    <div class="table-container">
                        ...
                        <?php else: ?>
                            <div class="no-data">
                                <i class="fas fa-laptop" style="font-size: 50px; color: #ddd; margin-bottom: 15px;"></i>
                                <h4>Belum ada produk Mac</h4>
                                <p>Mulai dengan menambahkan produk Mac pertama Anda</p>
                                <a href="add-mac.php" class="btn-add mt-3" style="display: inline-flex;">
