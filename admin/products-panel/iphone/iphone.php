...
// Dapatkan ID pertama untuk iPhone
$iphone_first_id_query = "SELECT MIN(id) as first_id FROM admin_produk_iphone";
$iphone_first_id_result = mysqli_query($db, $iphone_first_id_query);
$iphone_first_id_data = mysqli_fetch_assoc($iphone_first_id_result);
$iphone_first_id = $iphone_first_id_data['first_id'];
            ...
            <div class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="iphone.php<?php echo $iphone_first_id ? '?id=' . $iphone_first_id : ''; ?>">
                    ...
                    <div class="table-container">
                        <?php if (mysqli_num_rows($result) > 0): ?>
                            <table>
                                ...
                                <tbody>
                                    <?php
                                    $no = 1; // Deklarasi counter di sini, sebelum loop dimulai
