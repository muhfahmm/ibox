...
try {
    ...
    // 2. Update Gambar
    mysqli_query($db, "DELETE FROM admin_produk_iphone_gambar WHERE produk_id = '$product_id'");
    ...
    // 3. Update Kombinasi
    mysqli_query($db, "DELETE FROM admin_produk_iphone_kombinasi WHERE produk_id = '$product_id'");
    ...
    $response['message'] = "Produk iPhone berhasil diperbarui dengan $count kombinasi data.";
