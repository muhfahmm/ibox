...
$query_combinations = "SELECT * FROM admin_produk_iphone_kombinasi WHERE produk_id = '$product_id' ORDER BY warna, penyimpanan, konektivitas";
...
<head>
    ...
    <title>Detail Produk iPhone - <?php echo htmlspecialchars($product['nama_produk']); ?></title>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h2>
                        ...
                        Detail Produk iPhone
                    </h2>
                    <div>
                        <a href="iphone.php" class="btn-back me-2">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        <a href="edit-iphone.php?id=<?php echo $product_id; ?>" class="btn-edit">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mt-5 pt-4 border-top">
                    ...
                    <div>
                        <a href="edit-iphone.php?id=<?php echo $product_id; ?>" class="btn-edit me-2">
                            <i class="fas fa-edit"></i> Edit Produk
                        </a>
                        <a href="delete-iphone.php?id=<?php echo $product_id; ?>" 
