...
// Dapatkan ID pertama untuk Aksesoris
$aksesoris_first_id_query = "SELECT MIN(id) as first_id FROM admin_produk_aksesoris";
$aksesoris_first_id_result = mysqli_query($db, $aksesoris_first_id_query);
$aksesoris_first_id_data = mysqli_fetch_assoc($aksesoris_first_id_result);
$aksesoris_first_id = $aksesoris_first_id_data['first_id'];
...
<head>
    ...
    <title>Admin Panel - Kelola Aksesoris</title>
    ...
    <style>
        * {
        ...
        .kategori-case { background-color: #e8f5e9; color: #2e7d32; }
        .kategori-charger { background-color: #fff3e0; color: #ef6c00; }
        .kategori-headphone { background-color: #f3e5f5; color: #7b1fa2; }
        .kategori-keyboard { background-color: #e8eaf6; color: #303f9f; }
        .kategori-mouse { background-color: #fff8e1; color: #ff8f00; }
        .kategori-trackpad { background-color: #e0f2f1; color: #00695c; }
        .kategori-adapter { background-color: #fce4ec; color: #c2185b; }
        .kategori-other { background-color: #f5f5f5; color: #616161; }
    ...
    <div class="admin-container">
            ...
            <div class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="aksesoris.php<?php echo $aksesoris_first_id ? '?id=' . $aksesoris_first_id : ''; ?>">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1><i class="fas fa-toolbox me-2"></i> Kelola Produk Aksesoris</h1>
                <a href="add-aksesoris.php" class="btn-add">
                    <i class="fas fa-plus"></i> Tambah Produk Aksesoris
                </a>
            </div>

            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-list me-2"></i> Daftar Produk Aksesoris</h3>
                </div>
                <div class="card-body">
                    <div class="table-container">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php while($product = mysqli_fetch_assoc($result)): 
                                        ...
                                        $query_thumbnail = "SELECT foto_thumbnail FROM admin_produk_aksesoris_gambar WHERE produk_id = '{$product['id']}' LIMIT 1";
                                        ...
                                        $query_warna = "SELECT DISTINCT warna FROM admin_produk_aksesoris_kombinasi WHERE produk_id = '{$product['id']}'";
                                        $result_warna = mysqli_query($db, $query_warna);
                                        $warna_list = mysqli_fetch_all($result_warna, MYSQLI_ASSOC);
                                        
                                        // Ambil semua tipe
                                        $query_tipe = "SELECT DISTINCT tipe FROM admin_produk_aksesoris_kombinasi WHERE produk_id = '{$product['id']}'";
                                        $result_tipe = mysqli_query($db, $query_tipe);
                                        $tipe_list = mysqli_fetch_all($result_tipe, MYSQLI_ASSOC);
                                        
                                        // Check if product has stock
                                        $has_stock = $product['total_stok'] > 0;
                                        
                                        // Kategori mapping untuk class CSS
                                        $kategori_class = 'kategori-' . strtolower(str_replace(' ', '-', $product['kategori'] ?? 'other'));
                                    ?>
                                    <tr>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <?php else: ?>
                                                    <div class="thumbnail-img" style="background: #f0f0f0; display: flex; align-items: center; justify-content: center;">
                                                        <i class="fas fa-toolbox" style="color: #ccc; font-size: 24px;"></i>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="product-stats">
                                                ...
                                                <span class="stat-badge">
                                                    ...
                                                    <?php 
                                                    $tipe_names = array_column($tipe_list, 'tipe');
                                                    echo implode(', ', array_slice($tipe_names, 0, 2));
                                                    if(count($tipe_names) > 2) echo '...';
                                                    ?>
                                                </span>
                                                <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="view-aksesoris.php?id=<?php echo $product['id']; ?>" class="btn-view">
                                                    <i class="fas fa-eye"></i> Lihat
                                                </a>
                                                <a href="edit-aksesoris.php?id=<?php echo $product['id']; ?>" class="btn-edit">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="delete-aksesoris.php?id=<?php echo $product['id']; ?>" class="btn-delete" 
                        ...
                        <?php else: ?>
                            <div class="no-data">
                                <i class="fas fa-toolbox"></i>
                                <h4>Belum ada produk Aksesoris</h4>
                                <p>Mulai dengan menambahkan produk Aksesoris pertama Anda</p>
                                <a href="add-aksesoris.php" class="btn-add mt-3" style="display: inline-flex;">
