...
<body>
    <div class="container">
        <h1><i class="fas fa-fire" style="color: #4a6cf7;"></i> Tambah Produk Populer</h1>
        
        <form id="addPopulerForm">
            ...
            <div class="form-group">
                <label><i class="fas fa-tag me-2"></i>Label</label>
                <input type="text" name="label" placeholder="Contoh: Populer, Terlaris, Rekomendasi" required>
                <small class="help-text">Label ini akan muncul sebagai badge di produk.</small>
            </div>
            ...
            <button type="submit" class="btn-submit" id="btnSubmit">
                <i class="fas fa-save me-2"></i> Simpan Produk Populer
            </button>
    ...
    <script>
        ...
        document.getElementById('addPopulerForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            fetch('api/api-add-produk-populer.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        ...
                        window.location.href = 'produk-populer.php?success=added';
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
                    ...
                    btnSubmit.innerHTML = '<i class="fas fa-save me-2"></i> Simpan Produk Populer';
                }
            })
            .catch(error => {
