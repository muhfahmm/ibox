...
<head>
    ...
    <title>Tambah Checkout Sekarang</title>
...
<body>
    <div class="container">
        <h1><i class="fas fa-shopping-bag" style="color: #4a6cf7;"></i> Tambah Checkout Sekarang</h1>
        
        <form id="addCheckoutForm" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi_produk" rows="4" placeholder="Masukkan deskripsi produk yang akan ditampilkan di halaman depan..." style="width: 100%; padding: 14px; border: 1px solid #e0e0e0; border-radius: 12px; font-size: 15px; transition: all 0.3s ease; background-color: #fcfcfc; font-family: 'Poppins', sans-serif; resize: vertical;"></textarea>
            ...
            <button type="submit" class="btn-submit" id="btnSubmit">
                <i class="fas fa-save me-2"></i> Simpan Checkout
            </button>
    ...
    <script>
        ...
        document.getElementById('addCheckoutForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            fetch('api/api-add-checkout-sekarang.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        ...
                        window.location.href = 'chekout-sekarang.php?success=added';
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
                    ...
                    btnSubmit.innerHTML = '<i class="fas fa-save me-2"></i> Simpan Checkout';
                }
            })
            .catch(error => {
