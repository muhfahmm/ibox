...
<head>
    ...
    <title>Detail Checkout Sekarang</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-eye"></i> Detail Checkout Sekarang</h1>
            <a href="chekout-sekarang.php" class="btn btn-secondary">
            ...
            <div class="product-info">
                ...
                <div class="info-group">
                    ...
                    <div class="description-box">
                        <?php 
                        // Query sudah mengambil deskripsi_produk dari home_checkout jika ada, jika tidak dari produk
                        $deskripsi_tampil = $data['deskripsi_produk'] ?? 'Tidak ada deskripsi';
                        echo nl2br(htmlspecialchars($deskripsi_tampil)); 
                        ?>
                    </div>
                </div>

                <div class="btn-group">
                    <a href="edit-checkout-sekarang.php?id=<?php echo $data['id']; ?>" class="btn btn-primary">
                        <i class="fas fa-edit"></i> Edit Checkout
                    </a>
                    <a href="delete-acheckout-sekarang.php?id=<?php echo $data['id']; ?>" class="btn btn-secondary" 
