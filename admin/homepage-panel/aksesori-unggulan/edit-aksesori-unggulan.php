...
$stmt = $db->prepare("SELECT * FROM home_aksesori WHERE id = ?");
...
<head>
    ...
    <title>Edit Aksesori Unggulan</title>
...
<body>
    <div class="container">
        <h1><i class="fas fa-edit" style="color: #4a6cf7;"></i> Edit Aksesori Unggulan</h1>
        
        <form id="editAksesoriForm">
            ...
            <button type="submit" class="btn-submit" id="btnSubmit">
                <i class="fas fa-save me-2"></i> Update Aksesori Unggulan
            </button>
    ...
    <script>
        ...
        document.getElementById('editAksesoriForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            fetch('api/edit-aksesori-unggulan.php', {
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        ...
                        window.location.href = 'aksesori-unggulan.php?success=updated';
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
                    ...
                    btnSubmit.innerHTML = '<i class="fas fa-save me-2"></i> Update Aksesori Unggulan';
                }
            })
            .catch(error => {
